...
> This will be a very cool project! If you want to go deeper, you could do a
> pilot human study: get a few friends who are not familiar with the environment,
> and see if the explanations that you generate make sense to them.
...
- If we pursue it: recruit a handful of participants unfamiliar with MiniGrid,
  ...
  MCTS-tree), and collect ratings on clarity/plausibility/usefulness.
